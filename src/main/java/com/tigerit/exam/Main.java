...
public class Main{
            ...
            for (caseNo = 1; caseNo <= numberOfTestCases; caseNo++) 
            {
                ...
                for(queryNo=1;queryNo<=numberOfQuery;queryNo++)
                {
                   ...
                   if(SELECTLine[1].compareTo("*")==0)  // Either query type 1 or 2
                   {
                        ...
                        MatchAndJoinAll(myTables[firstTableId], myTables[secondTableId],firstTableColumnNo,secondTableColumNo);
                   }
                   else // query type 3
                   {
                        Integer firstTableId = tableNameHashValue.get(FROMLine[1]);
                        ...
                        MatchAndJoinSome(myTables[firstTableId], myTables[secondTableId], firstTableColumnNo, secondTableColumNo, selectedColumns);
                   }
	...
	public void MatchAndJoinAll(Table firstTable, Table secondTable, Integer firstTableColumnNo,Integer secondTableColumnNo)
    {
       Integer i,j,k;
    ...
    public void MatchAndJoinSome(Table firstTable, Table secondTable, Integer firstTableColumnNo, Integer secondTableColumnNo, List<Integer>selectedColumns)
    {
        Integer i, j, k,c;
        resultColumnNames = new ArrayList<String>();
        resultRecords = new ArrayList<List<Integer>>();
